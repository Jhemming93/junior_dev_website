...
<div class="py-2">
   ...
   <div class="d-flex flex-wrap justify-content-center">
      <?= view_cell('NavCardCell', 'title=Portfolio Gallery, link=/portfolio, description=Check out unior Developers Portfolios, image=img-defaults/portfolio-gallery.webp') ?>
